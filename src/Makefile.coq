...
Makefile.coq.conf: 
	coq_makefile -R . StructPoly -install none -o Makefile.coq Instances.v ListLike.v
...
html: $(GLOBFILES) $(VFILES)
	$(SHOW)'COQDOC -d doc $(GAL)'
	$(HIDE)mkdir -p doc
	$(HIDE)$(COQDOC) \
		-toc $(COQDOCFLAGS) -html $(GAL) $(COQDOCLIBS) -d doc $(VFILES)
